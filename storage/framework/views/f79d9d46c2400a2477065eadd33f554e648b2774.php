...
<body>
    ...
    <section id="users">
        <div class="container p-5">
            <p>Editar Usuario</p>
            <div class="row">
                    <p>Usuario: <?php echo e($user->nome); ?>  </p>
            </div>
            <form method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Nome</label>
                                    <input type="text" name="nome" class="form-control" value="<?php echo e($user->nome); ?> "
...
<?php /**PATH C:\Users\andre\Downloads\aula-05\laravel-aula-05\resources\views/usuario.blade.php ENDPATH**/ ?>